...
<div class="app">
  <header v-if="isLogged" class="header">
    ...
    <div class="userinfo" >
        ...
        <button class="logout material-icons" type="button" title="Выйти" @click="onLogout" @keyup.space.enter="onLogout" >logout</button>
    </div>
    <button class="material-icons mobile" type="button" 
  ...
  <button type="button" class="material-icons btn-feedback" title="Обратная связь" v-show="!showFeed" @click="showFeed=!showFeed">feedback</button>
